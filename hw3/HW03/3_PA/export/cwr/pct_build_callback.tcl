::namespace eval ::pct::build {
  ...
  proc callback {args} {
    ...
    [namespace current]::add_vppack_path "[::subst -nobackslashes -nocommands {/RAID2/COURSE/DCS/DCS111/HW03/3_PA/export/parameters/HARDWARE.unevald.parameters}]" "[::subst -nobackslashes -nocommands {simulation/parameters}]"
  }
